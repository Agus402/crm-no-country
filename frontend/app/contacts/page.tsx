...
// Lista de Stages disponibles para el filtro
...
export default function ContactPage() {
  ...
  const filteredContacts = contacts.filter((contact) => {
    ...
    const matchesStage =
      stageFilter === "All Stages" || contact.stage === stageFilter;
      ...
      <div className="bg-white border-b border-gray-200 p-4 md:px-8 md:py-6">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4">
          <div>
            ...
            <p className="text-sm md:text-base text-gray-600 mt-1">Manage and segment your contacts across the sales funnel. </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 gap-2 lg:flex lg:gap-3">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="outline"
                  className={stageFilter !== "All Stages"? "bg-purple-50 border-purple-200 text-purple-700": "" } >
                  <Filter className="h-4 w-4 mr-2" />
                  {stageFilter === "All Stages" ? "Filter" : stageFilter}
                </Button>
              </DropdownMenuTrigger>
