      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex gap-2 pt-2">
            ...
            <Button variant="outline" className="text-red-500 hover:text-red-600">Disconnect</Button>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <Input defaultValue="sk_live_51JAbcDEF123456789..." readOnly className="bg-gray-50 font-mono" />
